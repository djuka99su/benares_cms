...
const ModalItem = ({ modal, closeModal, editState,  indexEdit, categories }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("http://localhost:3000/api/categories/items", {
        ...
        body: JSON.stringify({ title: createName, price:createPrice, category: categoryState, allergens: allergensState, description: createDescr }),
      });
            ...
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                  {editState ? "Edit product" : "Create New Product"}
                </h3>
                <button
                  type="button"
              ...
              <form onSubmit={handleSubmit} className="p-4 md:p-5">
                <div className="grid gap-4 mb-4 grid-cols-2">
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      placeholder={editState ? editName : "Type product name"}
                      value={editState ? editName : createName}
                      onChange={
                        editState
                  ...
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      id="allergens"
                      className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                      placeholder={editState ? editName : "Allergens"}
                      value={editState ? editName : allergensState}
                      onChange={
                        editState
                          ? ""
                          : (e) => setAllergensState(e.target.value)
                      }
                      required
                    />
                  </div>
                  <div className="col-span-2 sm:col-span-1">
                    ...
                    <input
                      ...
                      value={editState ? editPrice : createPrice}
                      onChange={
                        editState
                          ? (e) => setEditPrice(e.target.value)
                          : (e) => setCreatePrice(e.target.value)
                      }
                      required
                    />
                  </div>
                  ...
                  <div className="col-span-2">
                    ...
                    <textarea
                      ...
                      value={editState ? editDescr : createDescr}
                      placeholder="Description"
                      onChange={
                        editState
                          ? (e) => setEditDescr(e.target.value)
                          : (e) => setCreateDescr(e.target.value)
                      }
                    />
                  </div>
                </div>
                ...
                >
                  ...
                  {editState ? "Edit product" : "Add new product"}
                </button>
              </form>
            </div>
          </div>
